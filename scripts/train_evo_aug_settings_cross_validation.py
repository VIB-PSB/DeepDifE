...
def run_model(output_file, augment_list):
	# Prepare the data
...
def main():
	base_path = "/home/ubuntu/DeepDifE/results/evoaug_augmentations/"
	...
	output_file = f"{base_path}random_insertions"
	augment_list = [
		augment.RandomInsertionBatch(insert_min=0, insert_max=20)
	]
	run_model(output_file, augment_list)

	output_file = f"{base_path}random_deletion"
	augment_list = [
		augment.RandomDeletion(delete_min=0, delete_max=30),
	]
	run_model(output_file, augment_list)

	output_file = f"{base_path}random_translocation"
	augment_list = [
		augment.RandomTranslocationBatch(shift_min=0, shift_max=20)
	]
	run_model(output_file, augment_list)

	output_file = f"{base_path}random_mutation"
	augment_list = [
		augment.RandomMutation(mutate_frac=0.05)
	]
	run_model(output_file, augment_list)

	output_file = f"{base_path}RandomNoise"
	augment_list = [
		augment.RandomMutation(mutate_frac=0.05)
	]
	run_model(output_file, augment_list)

	# ----------------------- LEAVE ONE OUT AUGMENTATION -----------------------
	output_file = f"{base_path}no_random_insertions"
	augment_list = [
		augment.RandomDeletion(delete_min=0, delete_max=30),
		augment.RandomTranslocationBatch(shift_min=0, shift_max=20),
		augment.RandomMutation(mutate_frac=0.05),
	...
	output_file = f"{base_path}no_random_deletion"
	augment_list = [
		augment.RandomInsertionBatch(insert_min=0, insert_max=20),
		augment.RandomTranslocationBatch(shift_min=0, shift_max=20),
		augment.RandomMutation(mutate_frac=0.05),
	...
	output_file = f"{base_path}no_random_translocation"
	augment_list = [
		augment.RandomInsertionBatch(insert_min=0, insert_max=20),
		augment.RandomDeletion(delete_min=0, delete_max=30),
		augment.RandomMutation(mutate_frac=0.05),
	...
	output_file = f"{base_path}no_random_mutation"
	augment_list = [
		augment.RandomInsertionBatch(insert_min=0, insert_max=20),
		augment.RandomDeletion(delete_min=0, delete_max=30),
		augment.RandomTranslocationBatch(shift_min=0, shift_max=20),
	...
	output_file = f"{base_path}no_random_noise"
	augment_list = [
		augment.RandomInsertionBatch(insert_min=0, insert_max=20),
		augment.RandomDeletion(delete_min=0, delete_max=30),
		augment.RandomTranslocationBatch(shift_min=0, shift_max=20),
