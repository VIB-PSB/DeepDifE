...
def main():
	...
	species_to_include = ["ath-an1","ath-c24","ath-cvi","ath-eri","ath-kyo","ath-ler","ath-sha"]
	...
	for i in range(0,10):
		...
		f = open("/home/ubuntu/DeepDifE/results/result_phylo_cross_validation_only_accessions.csv", "a")
