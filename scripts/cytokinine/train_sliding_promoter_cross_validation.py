...
def main():
	# Prepare the data
	ppath = "/home/ubuntu/DeepDifE/cytokinine_data/promoter_sliding_window.pkl"
	...
	# Only the train genes are in this pickle included
	train_df = dataset
	...
	for i in range(0,10):
		...
		f = open("/home/ubuntu/DeepDifE/cytokinine_data/results/result_sliding_promoter_cross_validation.csv", "a")
