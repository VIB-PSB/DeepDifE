...
def main():
	...
	augment_list = [
		...
		augment.RandomTranslocationBatch(shift_min=0, shift_max=100),
	...
	f = open("/home/ubuntu/DeepDifE/cytokinine_data/results/result_cytokinine_with_evo_aug", "a")
	f.write("loss,accurcay,auroc,auprc,TP,test_auroc,train_auroc,finetune_loss,finetune_accurcay,finetune_auroc,finetune_auprc,finetune_TP,finetune_test_auroc,finetune_train_auroc")
	f.close()
	...
	for i in range(0,10):
		...
		f = open("/home/ubuntu/DeepDifE/cytokinine_data/results/result_cytokinine_with_evoaug", "a")
